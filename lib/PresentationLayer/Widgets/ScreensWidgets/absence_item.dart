...
class AbsenceItem extends StatelessWidget {
          ...
          children: [
            ...
            Center(
              child: MaterialButton(
                ...
                onPressed: absence.justification!.isNotEmpty
                    ? null // تعطيل الزر إذا كان التبرير موجود بالفعل
                    : () {
                  _showJustificationDialog(context, absence);
                },
                child: Text(
                  absence.justification!.isNotEmpty ? 'تم التبرير' : 'تبرير',
                  style: UITextStyle.titleBold.copyWith(color:  absence.justification!.isNotEmpty ? UIColors.white : UIColors.error
                      , fontSize: 22),
                ),
              ),
            ),
  ...
  void _showJustificationDialog(BuildContext context, Absence absence) {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          title: Text('إدخال التبرير',
            style: UITextStyle.titleBold.copyWith(color: UIColors.black),),
          content: TextField(
            controller: justificationController,
            decoration: const InputDecoration(hintText: "أدخل التبرير هنا",
